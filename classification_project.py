...
df.drop([0], axis=0, inplace=True) #satır çıkarma
...
# ********************* Preprocessing ******************************************
preprocessing_data = pd.DataFrame(StandardScaler().fit(df).transform(df),columns=('signal_id','id_measurement','phase','target'))
# ******************************************************************************
